...
# @Test Condition:        1.无
# @Test Step:             1.调用 SetLocale 函数,传入错误的语言信息
...
class TestCase(OSBase):
    ...
    @pytest.mark.public
    def test_step(self):
        self.Step("步骤1:调用 SetLocale 函数,传入错误的语言信息")
        apiLocaleHelper.setLocale(locale='test', target='error', passwd=self.passwd)
